 ...
 * worked after 40 hrs.
 *
 * Created on January 18, 2018, 2:51 PM
 */
...
int main(int argc, char** argv) {
    ...
    switch(hrsWorked <= 40 && hrsWorked >= 0 && payRate >= 0)
    {
        case 1 : cout << "You have earned $" << payCheck << ".";
        break;
        default : {
            switch(hrsWorked > 40)
            {
            case 1 : cout << "You have earned $" << abv40Pay+ ((2 * payRate) * (hrsWorked - 40)) << ".";
            break;
            default : cout << "Please enter a number greater than or equal to 0.";
            }
        }
    }
    return 0;
