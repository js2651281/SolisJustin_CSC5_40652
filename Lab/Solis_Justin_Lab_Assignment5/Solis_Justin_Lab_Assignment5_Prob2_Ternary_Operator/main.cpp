 ...
 * worked after 40 hrs.
 *
 * Created on January 18, 2018, 3:13 PM
 */
...
int main(int argc, char** argv) {
    ...
    hrsWorked <= 40 && hrsWorked >= 0 && payRate >= 0 ? cout << "You have earned $" << payCheck << "." 
            : cout << "";
    hrsWorked >= 40 && hrsWorked >= 0 && payRate >= 0 ? cout << "You have earned $" << abv40Pay+ ((2 * payRate) * (hrsWorked - 40)) << "."
            : cout << "";
    hrsWorked < 0 || payRate < 0 ? cout << "Please enter a number greater than or equal to 0."
            : cout << "";
    return 0;
}
